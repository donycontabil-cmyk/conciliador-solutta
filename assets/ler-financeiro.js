...
(function (raiz, fabrica) {
  ...
  const SINONIMOS = {
    // "nomeparceiroparceiro" = "Nome Parceiro (Parceiro)" do aging de um cliente (o fornecedor). Vem ANTES
    ...
    // "vlrdodesdobramento" = coluna do aging de um cliente que o Dony usa (14/09/2026): é o valor
